    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="${path}/admin/loginOut">退出登陆</a></li>
            </ul>
        </div>
    </div>
</nav>
            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#centerLay').load('${path}/jsp/user.jsp')">用户管理</a></li>
                                <li><a href="javascript:$('#centerLay').load('${path}/jsp/echarts.jsp')">用户活跃度分析</a></li>
                                <li><a href="javascript:$('#centerLay').load('${path}/jsp/map.jsp')">用户地区分布</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="panel panel-success">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#centerLay').load('${path}/Album/album.jsp')">专辑管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="jumbotron" >
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <img src="../boot/img/2.jpg" alt="Third slide">
                        ...
                        <div class="item">
                            <img src="../boot/img/4.jpg" alt="Third slide">
